...
<body>
  ...
  <div class="container d-flex justify-content-around mt-5">
    ...
    <div class="card card-custom">
      <img src="img/image.png" class="card-img-top img-custom" alt="Empresa">
      <div class="card-body">
        <p class="card-text">Acesse as queixas recentes
        e a avaliação de sua empresa</p>
        <a href="#" class="btn btn-primary">Fazer login como empresa</a>
      </div>
    </div>
  </div>
</body>

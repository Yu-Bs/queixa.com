  ...
  <div class="container d-flex justify-content-around mt-5">
    ...
    <div class="card card-custom text-center">
      ...
      <div class="card-body">
        ...
        <a href="../actions/loginEmpresa.php" class="btn btn-custom-card">Fazer login como empresa</a>
      </div>
    </div>
    ...
    <div class="card card-custom text-center">
      ...
      <div class="card-body">
        ...
        <a href="../actions/loginUsuario.php" class="btn btn-custom-card">Fazer login como consumidor</a>
      </div>
    </div>
  </div>
</body>

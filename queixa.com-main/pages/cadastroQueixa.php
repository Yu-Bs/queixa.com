...
<body>
  ...
  <form method="POST" action="../actions/insertAvaliacao.php">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  empresaInput.addEventListener('input', () => {
    ...
    fetch(`../api/buscaEmpresas.php?termo=${encodeURIComponent(termo)}`)
      .then(r => r.json())
      .then(empresas => {
  ...
  prodInput.addEventListener('input', () => {
    ...
    fetch(`../api/buscaProdutos.php?termo=${encodeURIComponent(termo)}&empresaSelecionada=${encodeURIComponent(empresaSelecionada)}`)
      .then(r => r.json())
      .then(produtos => {
        listaProd.innerHTML = '';
        if (!produtos.length) {

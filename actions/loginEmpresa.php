...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand" href="../pages/MenuPrincipal.php">Queixa.com</a>
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
        <form class="d-flex mx-auto" role="search" method="get" action="../pages/perfilEmpresa.php">
        ...
        <div class="d-flex">
          <a href="../pages/loginEmpCon.php" class="btn btn-outline-custom">Entrar</a>
          <a href="../pages/cadastroEmpCon.php" class="btn btn-outline-custom ms-2">Cadastrar</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <div class="main-content">
    ...
    <div class="right-area">
      ...
      <a href="../pages/cadastroEmpresa.php" class="btn btn-custom">Cadastrar minha empresa</a>
    </div>
